...
// playButton
const playButton = this.add.image(505.0120544433594, 400, "playbutton");
playButton.setInteractive();
playButton.on("pointerup", () => this.scene.start("Level"));

// Adjust camera position
this.cameras.main.centerOn(505.0120544433594, 360);
